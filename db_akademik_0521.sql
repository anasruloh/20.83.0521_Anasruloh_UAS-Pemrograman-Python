...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2022 pada 09.36
...
--
-- Struktur dari tabel `tbl_students_0521`
--

CREATE TABLE `tbl_students_0521` (
  `id` int(2) NOT NULL,
  `nim` varchar(20) CHARACTER SET latin1 NOT NULL,
  `nama` varchar(50) CHARACTER SET latin1 NOT NULL,
  `jk` varchar(2) CHARACTER SET latin1 NOT NULL,
  `jurusan` varchar(20) CHARACTER SET latin1 NOT NULL,
  `alamat` varchar(20) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_students_0521`
--

INSERT INTO `tbl_students_0521` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
